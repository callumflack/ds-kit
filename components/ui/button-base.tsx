    ...
    variants: {
      variant: {
        ...
        reverse: [
          ...
          "aria-pressed:bg-background aria-pressed:border-background aria-pressed:text-foreground",
          "aria-pressed:hover:bg-background/80",
          "data-[state=open]:bg-background data-[state=open]:border-background data-[state=open]:text-foreground",
          "data-[state=open]:hover:bg-background/80",
          ...buttonTriggerRings,
        ],
        "reverse-outline": [
          "border border-background/50 bg-transparent text-background",
          "hover:bg-background/10 hover:border-background/80",
          // control states
        ...
        "case-study-link": [
          "pl-0! text-xlarge font-semibold text-(--highlight-color)",
...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      type={
        type ?? ("button" satisfies React.ButtonHTMLAttributes<HTMLButtonElement>["type"])
      }
      className={cn(buttonVariants({ variant, size, fullWidth, mono, className }))}
      {...(selected && {
        "data-state": "open",
        "aria-pressed": true,
        "aria-selected": true,
