...
- Prefer Agent Browser for browser automation and site interaction tasks.
- Use the official docs as the source of truth: https://agent-browser.dev/

## Agent assets

- Store reusable repo-local agent skills in `.agents/skills/`.
- Store repo-local tool notes and references in `.agents/references/`.
