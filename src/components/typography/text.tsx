  ...
  ],
  {
    variants: {
      ...
      intent: {
        ...
        label: ["font-medium text-small", labelStyle],
        small: "text-small",
        ...
        subtitle: "text-balance text-subtitle",
        title: "text-balance font-medium text-title",
        display: "-ml-[0.015em] text-balance font-medium text-display",
        hero: "-ml-[0.0175em] text-balance font-medium text-hero",
      },
